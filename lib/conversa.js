...
function conversaVazia(telefone) {
  return {
    ...
    cliente: { nome: "", cep: "", endereco: "", formaEntrega: "", precisaEntrar: null },
    pagamento: { tipo: "", trocoPara: "" },
    aguardandoConfirmacao: false,
    pedidoCriado: null, // orderId, quando já fechou
    pixAtual: null, // { orderId, copiaECola, qrBase64 } do último Pix gerado
    cepConsultado: null, // resultado do ViaCEP para o último CEP informado
